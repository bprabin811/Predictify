...
const FeatureEngineering = () => {
  ...
  return (
    <div className="w-full container flex items-start justify-start">
      <div className="min-h-[80vh] w-[20%] border-r py-4 pr-4 h-full flex flex-col gap-4">
      ...
      <div className="w-[80%] h-full  flex flex-col gap-4 overflow-auto pb-20">
        <div className=" w-full flex gap-4 py-4 pl-4">
          <div className="flex-1 max-w-[500px]">
            <SelectColumnsComponent dataset={dummyData} selectedColumns={handleSelectedColumns} />
          </div>
          {isColumnsSelected && (
            <div className="flex-1 max-w-[500px]">
              <SelectMethods
